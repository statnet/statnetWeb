  ...
  tabPanel('About',
           fluidRow(
                    column(8, 
                           ...
                           p("Do you have comments/suggestions/complaints on this prototype app? Please share them with us.",
                             "They are best submitted through our", a('Github site,', 
                                                                      href='https://github.com/Statnet-Summer-Project/ergm-shiny',
                                                                      target='_blank'),
                             "or by email to ebey@uw.edu."),
                           h5('Citing statnet'),
             ...
             column(4, wellPanel( 
                          ...
                          br(),
                          br(),
                          a("Github repository", href="https://github.com/Statnet-Summer-Project/ergm-shiny",
                            target="_blank"),
                          br(),
           ...
           sidebarLayout(position = 'right',
                         ...
                         mainPanel(
                           ...
                           p("This app is maintained on Github. To request new features or report a bug,",
                             ...
                             a("repository", href='https://github.com/Statnet-Summer-Project/ergm-shiny'), 
