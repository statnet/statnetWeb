                                  ...
                                  span(style="line-height:25px;", class="helper",
                                      span(id="filetypehelper1",
                                           ...
                                           div(id="filetypebox1", class="mischelperbox",
                                               ...
                                               "the first row and column of", strong(".csv files"),
