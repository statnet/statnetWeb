...
#                "Geodesics are a dyad level measure for the shortest possible path between a pair of vertices.",
#                'If there is no path between a pair of vertices, the geodesic distance is "inf".',
...
#         ),
        tabPanel('More', value = 'More', br(),
           ...
           conditionalPanel("output.nwnum == 'multiple'",
                            ...
                            h5('Temporal network statistics', icon('angle-double-left')),
                            wellPanel(uiOutput("tstatterm_ui"),
...
#                                  "A vertex pair without any path connecting",
